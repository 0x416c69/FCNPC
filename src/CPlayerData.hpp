...
private:
    ...
    int64_t m_dwUpdateTick;
    int64_t m_dwMoveTickCount;
    int64_t m_dwReloadTickCount;
    int64_t m_dwShootTickCount;
    DWORD m_dwShootDelay;
    int64_t m_dwEnterExitTickCount;
    int64_t m_dwMoveStartTime;
    DWORD m_dwMoveTime;
    DWORD m_dwMoveStopDelay;
    DWORD m_dwMeleeDelay;
    DWORD m_dwKillVehicleTickCount;
    int64_t m_dwVehicleDeadTick;
